...
LOGGING = {
    ...
    "formatters": {
        ...
        "watchtower": {"format": "%(module)s %(process)d %(thread)d %(message)s"},
    },
    "handlers": {
        "mail_admins": {
            "level": "ERROR",
...
# Custom settings
# ------------------------------------------------------------------------------
DJANGO_FRONTEND_EMAIL_CONFIRMATION_URL = env.str(
    "DJANGO_FRONTEND_EMAIL_CONFIRMATION_URL"
)
DJANGO_FRONTEND_PASSWORD_RESET_URL = env.str("DJANGO_FRONTEND_PASSWORD_RESET_URL")

GRAPHENE = {"SCHEMA": "shops.schema.schema"}
